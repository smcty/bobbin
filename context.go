...
func WithContext(parent context.Context) (*Bobbin, context.Context) {
  var t Bobbin
  t.init()
  if parent.Done() != nil {
    go func() {
...
func (t *Bobbin) Context(parent context.Context) context.Context {
  t.init()
  t.m.Lock()
  defer t.m.Unlock()
...
func (t *Bobbin) addChild(parent context.Context, child context.Context, cancel func()) {
